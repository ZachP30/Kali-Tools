...
echo "➡️ Your default shell is now Fish, with Oh My Posh themes and your color scheme installed. NOTE: BE SURE TO CHANGE TERMINAL PREFERENCES TO Fira Code Nerd Font INSIDE YOUR TERMINAL SETTINGS AND SWITCH COLOR SCHEME TO Tokyo IN PREFERENCES!"
